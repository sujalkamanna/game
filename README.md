...
See it in action [here]Made just for fun. [Play it here!](http:/sujalkamanna.github.io/game.github.io)
To get source code follow (https://github.com/sujalkamanna/game.github.io). 
(Hit the auto-run button to let the AI attempt to solve it by itself)
...
git clone ( https://github.com/sujalkamanna/game.github.io.git )
